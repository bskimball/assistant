    ...
    <PageShell atmosphere="focus" density="medium">
      ...
      <div className="mb-8 rounded-2xl border-primary/20 bg-card p-6 shadow-sm ring-1 ring-foreground/10 sm:p-8">
        ...
        <p className="mt-3 max-w-2xl text-pretty text-base leading-7 text-muted-foreground">
          A voice-native AI coach that brings a life coach, personal trainer, and financial advisor
          into one place — turning what you log each day into specific, encouraging next steps
          across fitness, nutrition, finance, family, and focus.
        </p>
      ...
      <div className="mb-8 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {PILLARS.map(({ Icon, title, body }) => (
          ...
          >
            ...
            <CardContent className="text-pretty text-sm text-muted-foreground">{body}</CardContent>
          </Card>
        ))}
      </div>
